...
export async function runTurnStream(
  ...
  const unlisten = await listen<TurnStreamEventPayload>("turn_stream_chunk", (event) => {
...
export async function updateGlobalGameData(data: GlobalGameData): Promise<GlobalGameData> {
